...
--
-- Hôte : localhost
-- Généré le : Dim 16 mai 2021 à 20:16
...
(1, 'Harry Potter', 'https://images.pexels.com/photos/1005012/pexels-photo-1005012.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500'),
(2, '\r\nSigles Français', 'https://images.pexels.com/photos/278887/pexels-photo-278887.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500'),
(3, '\r\nDéfinitions de mots', 'https://images.pexels.com/photos/267669/pexels-photo-267669.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940'),
(4, '\r\nLes spécialités culinaires', 'https://images.pexels.com/photos/5490828/pexels-photo-5490828.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940'),
(5, '\r\nSéries TV : les simpson - partie 1', 'https://live.staticflickr.com/1/1016855_8712acf0d2.jpg'),
(6, '\r\nSéries TV : les simpson - partie 2', 'https://i.pinimg.com/originals/ee/6a/4f/ee6a4fcddf78fafdaada798cebd62cb4.jpg'),
(7, '\r\nSéries TV : Stargate SG1', 'https://i.skyrock.net/0507/37480507/pics/1458122153.jpg'),
(8, '\r\nSéries TV : NCIS', 'https://premiere.fr/sites/default/files/styles/scale_crop_1280x720/public/2021-03/2208907.jpg-r_1280_720-f_jpg-q_x-xxyxx.jpg'),
(9, '\r\nJeux de société', 'https://images.pexels.com/photos/4620973/pexels-photo-4620973.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260'),
(10, '\r\nProgrammation', 'https://images.pexels.com/photos/577585/pexels-photo-577585.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940'),
(11, '\r\nSigles informatiques', 'https://images.pexels.com/photos/785418/pexels-photo-785418.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940');
...
('DoctrineMigrations\\Version20210510105444', '2021-05-10 12:55:00', 964),
('DoctrineMigrations\\Version20210511081810', '2021-05-11 10:18:20', 29);
...
INSERT INTO `question` (`id`, `categorie_id`, `content`) VALUES
...
INSERT INTO `reponse` (`id`, `question_id`, `content`, `reponse_expected`) VALUES
(1, 1, 'Un fou', 1),
(2, 1, 'Une tour', 0),
(3, 1, 'Un pion', 0),
(4, 2, 'Sorbet Citron', 1),
...
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `is_verified`, `name`, `image`, `updated_at`) VALUES
(1, 'garance.tartas@gmail.com', '[\"ROLE_ADMIN\"]', '$argon2id$v=19$m=65536,t=4,p=1$sOk0GtQQfntwVEdBAYwnRg$jiQPEIUCo+4OHB9rAzaF8aYgziindf1BwoLerYlnj20', 1, NULL, 'memberf10.jpg', '2021-05-11 12:00:53'),
(2, 'camille.honnette@gmail.fr', '[\"ROLE_USER\"]', '$argon2id$v=19$m=65536,t=4,p=1$EsrvIQRWNfz2i5OkfKWudA$6+CTXXi2eJwDMI9cqNVSDT4dcKuyimWrpLWCqZjfQuA', 1, NULL, 'singe.jpg', '2021-05-11 12:04:07'),
(3, 'barack.afritt@bachibouzouk', '[]', '$argon2id$v=19$m=65536,t=4,p=1$8AxneCICZKUrfZeG8PeLrQ$gX9dBcRyzmtT3AJSRxZ6M2oq/AXykSMxGc3nHWPqOO0', 0, NULL, NULL, NULL);
